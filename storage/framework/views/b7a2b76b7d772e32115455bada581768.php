...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.panel','data' => ['class' => 'flex flex-col text-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'flex flex-col text-center']); ?>
    <div class="self-start text-sm"><?php echo e($job->employer->name); ?></div>
        <div class="py-8">
            <h3 class="group-hover:text-blue-700 text-xl font-bold transition-color duration-300">
                <a href="<?php echo e($job->url); ?>" target="_blank">
                    <?php echo e($job->title); ?>

                </a>
            </h3>
            <p class="text-sm mt-4"><?php echo e($job->schedule); ?> - <?php echo e($job->salary); ?></p>
        </div>

        <div class="flex justify-between iteams-center mt-auto">
            <div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.tag','data' => ['tag' => $tag,'size' => 'small']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.employer-logo','data' => ['employer' => $job->employer,'width' => 42]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\project1\resources\views/components/job-card.blade.php ENDPATH**/ ?>